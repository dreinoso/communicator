...
def send(contact, message):
	...
	if not contactExists:
		...
		if contactList.allowedIpAddress.has_key(contact):
			contactExists = True
		elif contactList.allowedMacAddress.has_key(contact):
			contactExists = True
		elif contactList.allowedEmails.has_key(contact):
			contactExists = True
		elif contactList.allowedNumbers.has_key(contact):
			contactExists = True
		else:
	...
	elif checkerInstance.availableBluetooth and bluetoothPriority != 0:
	...
	elif checkerInstance.availableEmail and emailPriority != 0:
	...
	elif checkerInstance.availableSms and smsPriority != 0:
